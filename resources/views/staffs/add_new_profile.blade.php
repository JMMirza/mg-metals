                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="form-label-group in-border">
                                <label class="form-check-label ml-2">
                                    <input class="form-check-input @if ($errors->has('customer_type')) is-invalid @endif"
                                        type="radio" name="customer_type" id="customer_type" value="individual" checked>
                                    Individual
                                </label>
                                <label class="form-check-label">
                                    <input class="form-check-input @if ($errors->has('customer_type')) is-invalid @endif"
                                        type="radio" name="customer_type" id="customer_type" value="corporate">
                                    Corporate
                                </label>
                                <div class="invalid-tooltip">
