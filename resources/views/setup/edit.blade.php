    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="row  needs-validation" action="{{ route('setup.update', $setup->id) }}" method="POST"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="home" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12 mb-3">
                                    <div id="snow-editor-des" style="height: 300px;">{!! $setup->description !!}</div>
                        ...
                        <div class="tab-pane" id="product1" role="tabpanel">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 mb-3">
                                    <div id="snow-editor-des-s-ch" style="height: 300px;">{!! $setup->description_s_ch !!}</div>
                                    <input type="hidden" name="description_s_ch" id="description_s_ch"
                                        value="{{ $setup->description_s_ch }}">
                                    {{-- <div class="form-label-group in-border">
                        ...
                        <div class="tab-pane" id="messages" role="tabpanel">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 mb-3">
                                    <div id="snow-editor-des-ch" style="height: 300px;">{!! $setup->description_ch !!}</div>
                                    <input type="hidden" name="description_ch" id="description_ch"
                                        value="{{ $setup->description_ch }}">
                                    {{-- <div class="form-label-group in-border">
