    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Add Manufacturer / 添加製造商 / 添加制造商</h4>
            </div>

            <div class="card-body">
                <form class="row  needs-validation" action="{{ route('manufacturers.store') }}" method="POST" novalidate>
                    @csrf
