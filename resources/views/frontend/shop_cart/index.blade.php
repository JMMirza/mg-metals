        ...
        <div class="container">
            <form id="customer_products_store" method="post" action="{{ route('customer-products.store') }}"
                ...
                <div class="col-lg-12 mb-20">
                    <div class="card mt-30 mb-30">
                        <div class="card-header">
                            ...
                            <div class="time-block">
                                <h5 class="card-title flex-grow-1 mb-0 ml-auto ms-auto">Shopping Cart</h5>
                                <div class="Timer"> </div>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card mt-30 mb-30">
                        <div class="card-header">
                            <h5 class="card-title flex-grow-1 mb-0">Delivery Method</h5>
                        </div>
                        <div class="card-body">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (method.toLowerCase() == 'bank transfer') {
                            ...
                            document.getElementById('total_price_hkd').style.display = "inline-block";
                            ...
                            document.getElementById('total_price_usd').style.display = "inline-block";
