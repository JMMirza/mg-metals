        ...
        <div class="container relative">
            <div class="row section-text mt-40 mb-30">
                <div class="col-12 col-md-4 pr-0">
                    <h3 class="playfare bold dark-light" style="font-size: 26px;line-height: 1.88em;">Every decade or so, dark
                        clouds will fill the economic skies, and they will briefly rain gold.</h3>
                        ...
                        <li>
                            <a href="#service-branding" class="nav-link active" data-bs-toggle="tab" role="tab"
                                ...
                                <p class="text-p font-alt">
                                    MG Metals accepts and trades high value physical gold. As long as you open a special
                                    account for gold bullion trading with us, you can deposit and trade physical gold at any
                                    time. MG Metals has a number of industry certifications, and all the gold bars it
                                    produces are approved by The Gold and Silver Exchange, Hong Kong. Investors can list
                                    their precious metals on The Gold and Silver Exchange during trading hours to sell and
                                    cash out at the market price, without worrying about extra fees paid to second-hand
                                    dealers.</p>
                            </a>
                        </li>
                        <li>
                            <a href="#service-web-design" class="nav-link" data-bs-toggle="tab" role="tab"
                                ...
                                <p class="text-p font-alt">
                                    We are one of few gold manufacturers with the accredited qualification. Our company has
                                    professional technical expertise and equipment to provide gold and silver recycling
                                    services for jewelry workshops, companies, recyclers, mining companies, and even retail
                                    customers. In 5 easy steps, you can instantly recycle gold and silver and cash out.want
                                    to share with your visitors.</p>
                            </a>
                        </li>
                        <li>
                            <a href="#service-graphic" class="nav-link" data-bs-toggle="tab" role="tab"
                                ...
                                <p class="text-p font-alt">MG Metals has been in the business of gold, stocks, futures,
                                    foreign exchange, capital, insurance, banking and loans for many years. With the group's
                                    knowledge and experience, the company is committed to provide financing solutions and
                                    foreign exchange solutions for various mining producers to help peers meet their funding
                                    needs and optimize their balance sheets.</p>
                            </a>
                        </li>
                        <li>
                            <a href="#service-development" class="nav-link" data-bs-toggle="tab" role="tab"
                                ...
                                <p class="text-p font-alt">Gold investments are not limited to just high net-worth
                                    investors. The team at MG Group has integrated technologies and developed mobile
                                    applications allowing retail investors to invest in gold anytime, anywhere in the world.
                                    In order to make gold investing more popular, the investment threshold can be as low as
                                    tens of dollars, and door-to-door delivery can be arranged regardless of the investment
                                    amount. Ours is the first gold investment platform specially designed for the public.
                                </p>
                            </a>
                        </li>
                ...
                <div class="col-12 col-md-6 align-self-center p-0">
                    ...
                    <div class="">
                        <div class="banner-content text-center">
                            ...
                            <div class="banner-decription dark text-left">Interested in any of our member services?
                                Sign up or log in to our member services portal
                                to continue with services offered by MG Metals.
                                Contact us if you need more information.</div>
