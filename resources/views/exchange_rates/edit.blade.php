<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="row  needs-validation" action="{{ route('exchange-rate.update', $exchangeRate->id) }}"
                    ...
                    <div class="col-md-6 col-sm-12 mb-3">
                        <div class="form-label-group in-border">
                            ...
                            <input type="text"
                                ...
                                value="{{ $exchangeRate->from_currency }}" required>
                    ...
                    <div class="col-md-6 col-sm-12 mb-3">
                        <div class="form-label-group in-border">
                            ...
                            <input type="text"
                                ...
                                value="{{ $exchangeRate->to_currency }}" required>
                            <div class="invalid-tooltip">
